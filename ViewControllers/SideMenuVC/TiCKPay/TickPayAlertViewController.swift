...
class TickPayAlertViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if SingletonClass.sharedInstance.strIsFirstTimeTickPay == "FromInVoice" {
            SetData()
        }
    }
    ...
    @IBAction func btnYes(_ sender: UIButton) {
        ...
        SingletonClass.sharedInstance.strIsFirstTimeTickPay = "FormAlertYes"
...
//        }
    ...
    @IBAction func btnNo(_ sender: UIButton) {
        ...
        SingletonClass.sharedInstance.strIsFirstTimeTickPay = "FormAlertNo"
